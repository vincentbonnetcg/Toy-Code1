...
def add_render_prefs(dynamic, render_prefs):
    # Render preferences used by render.py - TODO - should not be here
    ...
    dynamic.render_prefs = render_prefs
...
def create_wire_scene():
    ...
    add_render_prefs(wire, ['co', 0, 'm-', 1])
...
def create_beam_scene():
    ...
    add_render_prefs(beam, ['go', 1, 'k-', 1])
    ...
    add_render_prefs(wire, ['co', 1, 'm-', 1])
